...
3. Select pages to switch between different scatterplots.
...
- Designing publication-style scientific visuals in Power BI (scatterplots, histograms, spin vs event number)  
